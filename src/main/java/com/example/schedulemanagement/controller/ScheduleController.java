...
//    생성
    ...
    public ResponseEntity<CreateScheduleResponse> createScheduleResponse(@RequestBody CreateScheduleRequestDto requestDto){
        CreateScheduleResponse result = scheduleService.save(requestDto);
